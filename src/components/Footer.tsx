  ...
  <footer className="bg-nav py-8">
    <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <div className="flex gap-5">
        <a href="https://linkedin.com/in/poorvija" target="_blank" rel="noreferrer" className="text-nav-foreground/60 hover:text-primary transition-colors">
          <Linkedin size={20} />
        </a>
        <a href="https://github.com/poorvija" target="_blank" rel="noreferrer" className="text-nav-foreground/60 hover:text-primary transition-colors">
          <Github size={20} />
        </a>
